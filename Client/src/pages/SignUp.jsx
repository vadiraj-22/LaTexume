      ...
      <div className="relative w-full max-w-md animate-fade-in-up">
        ...
        <div className="bg-zinc-950/80 border border-zinc-800/90 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl hover:border-[#A6FF5D]/20 transition-all duration-300">
          ...
          <div className="flex flex-col items-center mb-6 text-center">
            ...
            <p className="text-zinc-400 text-sm mt-1.5">Start building ATS-optimised resumes</p>
          </div>
          ...
          <div className="flex flex-col items-center mb-6">
            <button
              ...
              className="group relative w-20 h-20 rounded-full border-2 border-dashed border-zinc-700 hover:border-[#A6FF5D] overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-[#A6FF5D]/20 bg-zinc-900/60"
            ...
            >
              {avatarPreview ? (
                ...
                <div className="flex flex-col items-center justify-center w-full h-full gap-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="text-zinc-400 group-hover:text-[#A6FF5D] transition-colors">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                  </svg>
                  <span className="text-[10px] text-zinc-400 group-hover:text-[#A6FF5D] transition-colors font-medium">Photo</span>
                </div>
              )}
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors" />
            </button>
            <input ref={avatarRef} type="file" accept="image/*" onChange={handleAvatarChange} className="hidden" id="avatar-input" />
            <span className="text-zinc-400 text-xs mt-2">Optional profile photo</span>
          </div>

          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            {/* Full Name */}
            <div>
              <label htmlFor="fullName" className="block text-zinc-300 text-sm font-medium mb-1.5">Full Name</label>
              <input
            ...
            {/* Email */}
            <div>
              <label htmlFor="reg-email" className="block text-zinc-300 text-sm font-medium mb-1.5">Email</label>
              <input
            ...
            {/* Password */}
            <div>
              <label htmlFor="reg-password" className="block text-zinc-300 text-sm font-medium mb-1.5">Password</label>
              ...
              {form.password && (
                <div className="mt-2.5 p-3 rounded-xl bg-zinc-900/90 border border-zinc-800 space-y-1 text-[11px] animate-fade-in">
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="confirmPassword" className="block text-zinc-300 text-sm font-medium mb-1.5">Confirm Password</label>
              <div className="relative">
                <input
            ...
            {success && (
              <div className="flex items-center gap-2.5 bg-[#A6FF5D]/10 border border-[#A6FF5D]/30 text-[#A6FF5D] rounded-xl px-4 py-3 text-xs sm:text-sm animate-fade-in">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} className="shrink-0">
          ...
          <p className="text-center text-zinc-400 text-sm mt-6">
            ...
            <Link to="/signin" className="text-[#A6FF5D] hover:underline font-semibold transition-colors">
              Sign in
            </Link>
          </p>
        </div>
