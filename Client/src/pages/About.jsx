      ...
      <main className="py-12 px-4 md:px-16 lg:px-24 xl:px-32">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-primary/20 to-primary/5 p-8 rounded-2xl border border-primary/30 text-center">
              ...
              <a href="/builder">
                <button className="bg-primary hover:bg-primary/90 text-gray-800 font-semibold px-8 py-4 rounded-full text-lg transition">
